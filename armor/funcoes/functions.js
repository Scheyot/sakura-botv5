...
const banner2 = cfonts.render(('SALVE MEUS CRIA, SCHEYOT AQUI:) ESPERO Q GOSTEM!!'), {
font: 'console',
align: 'center',
gradrient: [`${cor4}`,`${cor2}`], 
...
const banner3 = cfonts.render((`SAKURA
BOT-V5`), {
font: 'block',             
align: 'center',           
color: 'candy',
...
authorname = 'SAKURA-BOT-V5'
packname = '-MS-'
  
function addMetadata(packname, author) {	
if (!packname) packname = '-JR-'; if (!author) author = 'SAKURA-BOT'
...
chyt = `5512978986457@s.whatsapp.net`
